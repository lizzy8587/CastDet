...
@File         :   semi_base.py
@Version      :   1.0
@Time         :   2024/09/08 16:16:06
@E-mail       :   daodao123@sjtu.edu.cn
@Introduction :   Implementation of Base Semi-supervised Framework.

Ref: https://github.com/open-mmlab/mmdetection/blob/main/mmdet/models/detectors/semi_base.py
'''
...
from mmrotate.structures import RotatedBoxes, rbox_project
...
class RotatedSemiBaseDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        self.bbox_type = kwargs.get('bbox_type', None)
        self.rpn_bbox_type = kwargs.get('rpn_bbox_type', None)
        self.angle_version = self.teacher.roi_head.bbox_head.bbox_coder.angle_version
    ...
    def project_pseudo_instances(self, batch_pseudo_instances: SampleList,
        ...
        return filter_gt_instances(batch_data_samples, wh_thr=wh_thr, bbox_type=self.bbox_type)
