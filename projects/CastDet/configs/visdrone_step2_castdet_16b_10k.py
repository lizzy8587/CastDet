...
work_dir = 'work_dirs/visdrone_step2_castdet_16b_10k'

custom_imports = dict(
    imports=['projects.CastDet.castdet'], allow_failed_imports=False)

# frozen_stages = ['visual']
...
model = dict(
    ...
    pseudo_queue_cfg=dict(
        ...
        init_imgs_path="/hhd/datasets/ly/dior/OpenDataLab___DIOR/raw/DIOR/ImageSets/Main/visdrone_initialize_r1.0.txt"
    ),
