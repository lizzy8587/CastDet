...
from projects.GLIP.glip.atss_vlfusion_head import convert_grounding_to_cls_scores

from mmrotate.registry import MODELS
from mmrotate.models import RHINOHead
...
class RotatedGroundingDINOHead(RHINOHead):
